...
--
-- Host: localhost
-- Generation Time: Apr 12, 2023 at 02:07 AM
...
(5, 'arbai', '', 'arbai53@yahoo.com', '081268410654'),
(6, 'arbai', 'jln.merpati', 'arbai53@yahoo.com', '+6281268410654');
...
--
ALTER TABLE `perusahaan`
  MODIFY `kode_prsh` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
