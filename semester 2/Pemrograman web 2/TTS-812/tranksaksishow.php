...
<div class="search-form">
    <form method="GET">
      <input type="text" name="search" placeholder="ID Supplier..." value="<?php echo isset($_GET['search']) ? $_GET['search'] : ''; ?>">
  ...
  <table>
    ...
    <tbody>
      ...
      $qond = ($search === '') ? '' : "WHERE id_supp LIKE '%$search%'" ;
      $query = "SELECT * FROM far_ord_ri " . $qond . " ORDER BY no_sp ASC";
      ...
      while($user_data = mysqli_fetch_array($ambildata_perhalaman)) {
        ...
        echo "<td><button><a href='tranksaksiforminput.php?No=$user_data[no]'> Edit </a></button>
          <button><a href='function.php?No=$user_data[no]'> Hapus </a></button></td></tr>";
...
echo '<a href = "tranksaksishow.php?page=' . $page . '">'. $page .' </a>';

}

?>
    <div class="add-button">
        <button><a href='tranksaksiforminput.php'> Add </a></button>
      </div>
    </div>
