...
.search-form {
  ...
  <table id= "customers">
      ...
      $query = "SELECT * FROM perusahaan " . $qond . " ORDER BY NAMA_PRSH ASC";
      ...
      . "FROM perusahaan "
      . $qond
      . "ORDER BY NAMA_PRSH LIMIT " . $page_first_result . ',' . $results_per_page);
      while($user_data = mysqli_fetch_array($ambildata_perhalaman)) {
        ...
        echo "<a href='delete.php?KODE=$user_data[KODE]'> Hapus </a></td></tr>";
