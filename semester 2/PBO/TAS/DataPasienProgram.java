...
public class DataPasienProgram extends javax.swing.JFrame {
        ...
        private void initComponents() {
                ...
                cmbPoli.setModel(
                                new javax.swing.DefaultComboBoxModel<>(
                                                new String[] { "Penyakit Dalam", "THT", "Anak", "Kandungan" }));
        ...
        private void displayDataPasien() {
                ...
                for (Pasien pasien : dataPasien) {
                        System.out.println("No RM: " + pasien.getNoRM());
                        ...
                        System.out.println("Golongan Darah: " + pasien.getGolDarah());
                        System.out.println("Poli Spesialis: " + pasien.getPoli());
                        System.out.println("-----------------------");
                }
        }

        private void displayDataPasienText() {
